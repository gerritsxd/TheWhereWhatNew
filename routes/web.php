...
Route::get('/votebubble',[App\Http\Controllers\BubbleController::class, 'voteBubble']);

Route::get('/deletebubble',[App\Http\Controllers\BubbleController::class, 'deleteBubble'])->middleware('auth');
